...
class AllQuotesInQuotesScreen extends StatefulWidget {
  const AllQuotesInQuotesScreen({super.key, required this.str_category_id});

  final String str_category_id;

  @override
  State<AllQuotesInQuotesScreen> createState() =>
      _AllQuotesInQuotesScreenState();
}

class _AllQuotesInQuotesScreenState extends State<AllQuotesInQuotesScreen> {
  //
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: <Widget>[
          ...
          for (int i = 0; i < arr_quotes_list.length; i++) ...[
            Container(
              // height: 200,
              width: MediaQuery.of(context).size.width,
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: Text(
                    //
                    arr_quotes_list[i]['description'].toString(),
                    //
                    style: TextStyle(
                      fontFamily: font_style_name,
                      fontSize: 16.0,
    ...
    if (resposne.statusCode == 200) {
      if (get_data['status'].toString().toLowerCase() == 'success') {
        ...
        for (var i = 0; i < get_data['data'].length; i++) {
          ...
          arr_quotes_list.add(get_data['data'][i]);
        }
