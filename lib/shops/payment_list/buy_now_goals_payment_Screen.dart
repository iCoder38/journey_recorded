...
class BuyNowGoalsPaymentScreen extends StatefulWidget {
  const BuyNowGoalsPaymentScreen(
      {super.key,
  ...
  @override
  State<BuyNowGoalsPaymentScreen> createState() =>
      _BuyNowGoalsPaymentScreenState();
}

class _BuyNowGoalsPaymentScreenState extends State<BuyNowGoalsPaymentScreen> {
  //
  ...
  funcSendDataToServer() async {
    if (kDebugMode) {
      print('=====> POST : BUY NOW PAYMENT FOR GOAL');
    }
