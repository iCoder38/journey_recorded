...
class MissionDetailsScreen extends StatefulWidget {
  const MissionDetailsScreen(
      {super.key,
      required this.str_get_mission_id,
      required this.str_get_mission_goal_id,
      required this.str_get_mission_category_id,
      required this.str_get_mission_description,
      required this.str_get_mission_category_name,
      required this.str_get_mission_goal_name,
      required this.str_get_mission_user_name,
      required this.str_deadline});

  final String str_get_mission_id;

  final String str_get_mission_goal_id;
  final String str_get_mission_category_id;
  final String str_get_mission_description;
  final String str_get_mission_category_name;
  final String str_get_mission_goal_name;
  final String str_get_mission_user_name;
...
class _MissionDetailsScreenState extends State<MissionDetailsScreen> {
      ...
      home: DefaultTabController(
        ...
        child: Scaffold(
          appBar: AppBar(
              ...
              onTap: (value) {
                if (value == 1) {
                  ...
                  GoalNotesScreen(
                    ...
                    str_get_parse_name:
                        widget.str_get_mission_goal_name.toString(),
            ...
            title: Text(
              ///
              navigation_title_mission_details,
          ...
          body: TabBarView(
            children: <Widget>[
              // tab 1
              // mission_tabbar_info_UI(context),

              // tab 1
              GoalInfoScreen(
                str_get_category_name:
                    widget.str_get_mission_category_name.toString(),
                str_get_action_name: 'Mission',
                str_get_due_date: widget.str_deadline.toString(),
                str_about_goals: widget.str_get_mission_description.toString(),
                str_goal_name: widget.str_get_mission_goal_name,
                str_get_goal_id: widget.str_get_mission_goal_id.toString(),
              ),
              ...
              GoalNotesScreen(
                str_get_goal_id: widget.str_get_mission_id.toString(),
                str_get_due_date: widget.str_deadline,
                str_get_parse_name: widget.str_get_mission_goal_name.toString(),
                str_professional_type: 'Mission',
              ),
  ...
  SingleChildScrollView mission_tabbar_quotes_UI(BuildContext context) {
    return SingleChildScrollView(
      scrollDirection: Axis.vertical,
      child: Column(
        children: <Widget>[
          //
          mission_header_UI(context),
          //
          if (str_quotes == '0') ...[
            Center(
              child: Column(
  ...
  SingleChildScrollView mission_tabbar_info_UI(BuildContext context) {
    return SingleChildScrollView(
      scrollDirection: Axis.vertical,
      child: Column(
        children: [
  ...
  Container mission_header_UI(BuildContext context) {
    return Container(
      height: 200,
      width: MediaQuery.of(context).size.width,
      color: Colors.amber,
                          ...
                          Expanded(
                            child: IconButton(
                              onPressed: (() {
                                ...
                                str_profession_id = widget.str_get_mission_id;
                                str_professional_type = 'Mission';
    ...
    final resposne = await http.post(
      ...
      body: jsonEncode(
        <String, String>{
          ...
          'pageNo': '',
          'profesionalId': widget.str_get_mission_id.toString(),
          'profesionalType': 'Mission',
        },
      ),
    );
    ...
    final result = await Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => AddNoteInMission(
          str_profession_id: widget.str_get_mission_id.toString(),
          str_profession_type: 'Mission',
        ),
      ),
    );
    ...
    final result = await Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => AddQuotesScreen(
          str_add_quotes_main_id: widget.str_get_mission_id.toString(),
          str_profession_type: 'Mission'.toString(),
        ),
      ),
    );
