...
import 'package:journey_recorded/sub_goals/add_sub_goal/add_sub_goal_modal.dart';

import 'package:shared_preferences/shared_preferences.dart';

import 'package:http/http.dart' as http;

class AddSubGoalScreen extends StatefulWidget {
  const AddSubGoalScreen({super.key, required this.str_goal_id});

  final String str_goal_id;

  @override
  State<AddSubGoalScreen> createState() => _AddSubGoalScreenState();
}

class _AddSubGoalScreenState extends State<AddSubGoalScreen> {
  var str_add_sub_goal_loader = '0';
  //
  var str_goal_for_id;
  var str_category_id;
  //
  ...
  //
  CreateSubGoalModals create_sub_goal_modal_service = CreateSubGoalModals();
  //
  @override
  void initState() {
            ...
            if (str_add_sub_goal_loader == '0') ...[
              ...
              Container(
                ...
                child: TextFormField(
                  ...
                  decoration: const InputDecoration(
                    border: OutlineInputBorder(),
                    hintText: 'About your sub-goal',
                    labelText: 'About your sub-goal',
                  ),
                  maxLines: 3,
                ),
              ),
  ...
  func_save_and_continue_WB() {
    ...
    if (cont_name_of_goal.text == '') {
      ...
      _showMyDialog('About your sub goal field should not be empty.');
    } else {
      print('all values done.');
      print(widget.str_goal_id);
      create_sub_goal_modal_service
          .create_sub_goal_WB(
        ...
        (value) {
          ...
          if (value.success_alert.toLowerCase() == 'fails') {
            ...
            // success
            print('=====> Add Sub Goal Success <======');

            // Navigator.pop(context, value.message.toString());
            Navigator.pop(context, 'back_after_add_sub_goal');
            //
          }
        },
      );
