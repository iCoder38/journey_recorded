...
class Add_Note_Status {
  final String success_alert;
  final String message;
  // final String ;

  const Add_Note_Status({required this.success_alert, required this.message});

  factory Add_Note_Status.fromJson(Map<String, dynamic> json) {
    return Add_Note_Status(
...
class AddNoteModal {
  Future<Add_Note_Status> add_note_WB(String message, String professional_id,
      String professional_type, String category_id) async {
    //
    ...
    if (response.statusCode == 201) {
      ...
      return Add_Note_Status.fromJson(jsonDecode(response.body));
