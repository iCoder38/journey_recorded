...
class Add_Sub_Goal_Status {
  final String success_alert;
  final String message;
  // final String ;

  const Add_Sub_Goal_Status(
      {required this.success_alert, required this.message});

  factory Add_Sub_Goal_Status.fromJson(Map<String, dynamic> json) {
    return Add_Sub_Goal_Status(
...
class CreateSubGoalModals {
  Future<Add_Sub_Goal_Status> create_sub_goal_WB(
    String goal_type,
...
parentGoalId:
userId:
goalType:   //1. Self/Individual 2. Shop or authority 3. For Team or shop
name:
categoryId:
note:
deadline:  YYYY-mm-dd
...
*/
    ...
    if (response.statusCode == 201) {
      ...
      return Add_Sub_Goal_Status.fromJson(jsonDecode(response.body));
